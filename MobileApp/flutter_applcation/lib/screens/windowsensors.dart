...
class windowsensor extends StatefulWidget {
  late String value;
  windowsensor({required this.value});
  @override
  _windowsensorState createState() => _windowsensorState(value);
}

class _windowsensorState extends State<windowsensor> {
  late Future<sensor> futureAlbum;
  String value;
  _windowsensorState(this.value);
