...
class flamesensor extends StatefulWidget {
  late String value;
  flamesensor({required this.value});
  @override
  _flamesensorState createState() => _flamesensorState(value);
}

class _flamesensorState extends State<flamesensor> {
  late Future<sensor> futureAlbum;
  String value;
  _flamesensorState(this.value);

  Future<sensor> fetchAlbum() async {
    final response = await http.get(
        Uri.parse('http://10.0.2.2:3000/user/getflamesensordetails/' + value));
